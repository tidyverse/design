...
It's good practice to test both old and new versions of the code, although you won't be able to ever run both sets of tests in the same R session.

You have two basic options.

## Checking with multiple package versions
