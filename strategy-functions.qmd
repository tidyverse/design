# A complex strategy might be better as separate functions {#sec-strategy-functions}
...
You can continue to document the functions together, and they are likely to continuing to sharing multiple arguments, but
...
Deprecating it would require adding one deprecation for each branch:
