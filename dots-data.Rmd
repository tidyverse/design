...
In general, I think it is best to avoid using `...` for this purpose. 

## What are the downsides?

It has a relatively small benefit, only reducing typing by three letters `c()`, but has a number of costs:
...
If you've already publicised a function where you've used `...` for this purpose you can deprecated it as follows:
