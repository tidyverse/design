...
Often these problems arise because the scope of a function grows over time. When the function was initially designed, the scope was small, and it grows incrementally over time. Now, with hindsight It grew gradually over time, and no point did it seem worth the additional effort to refactor to a new design. This can make them hard to avoid. 
