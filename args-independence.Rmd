...
Avoid creating dependencies between details arguments so that only certain combinations are permitted. Dependencies between arguments makes functions harder to use because you have to remember how arguments interact.

## What are some examples?

*   In `rep()` you can supply both `times` and `each` _unless_
    `times` is a vector:
