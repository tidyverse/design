...
See Sections \@ref(args-mutually-exclusive) and \@ref(args-compound) for a specific exceptions where the dependency is via specific missing argument patterns.
...
Generally, you'll need to reconsider the complete interface. There are two common outcomes which are illustrated in the case studies below:
