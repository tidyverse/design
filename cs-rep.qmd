...
-   `rep_full()` has two mutually exclusive arguments (@sec-mutually-exclusive), either the number of times to repeat the whole vector or the desired length of the output.
