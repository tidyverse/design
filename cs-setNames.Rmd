...
Then we use in `set_names()`, replacing the existing `vec_assert()`. I separate the input checking and implementation with a blank line to help visually group the parts of the function.
...
We _could_ simplify the function even further, but I think this is a bad idea becaues it mindles input validation with implementation:
