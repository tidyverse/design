...
Note that suffix stripping and the substitution of `""` for `...` happens before the draft names are made syntactic. So, although `tibble:::make_syntactic`
turns `...` into `....`, universal or unique name repair will turn `...` into something of the form `...j`.
