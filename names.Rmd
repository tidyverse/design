...
In the tidyverse, when making names syntactic, we often go further and also make sure they are unique. Why? In practice, if you want syntactic names, you probably also want them to be unique. This is the meaning of `.name_repair = "semantic"` in tibble: user is requesting names that are unique and syntactic. *describes tibble > 1.4.2*
