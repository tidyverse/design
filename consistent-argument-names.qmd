...
-   I think `install.packages()` wins the prize for most varying argument styles.
    ...
    You can avoid this problem yourself by adopting a style guide (e.g. <https://style.tidyverse.org>).

-   Base R and stringr functions all use `pattern` to refer to the regular expression pattern to work this.
