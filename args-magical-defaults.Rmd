...
If you have a made a mistake in an older function you can remediate it by using a `NULL` default, as described in Chapter \@ref(args-defaults-short). If the problem is caused by an unexported function, you can also choose to document and export it.
