# Avoid hidden inputs {#args-hidden}
...
You can also make the use of the input less hidden by explicitly notifying the user whenever they rely on the default value that might vary in surprising ways. `install.packages()` does this to notify you about it's use of the `.libPath()` option.
